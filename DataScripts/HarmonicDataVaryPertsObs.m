    ...
    for numPerts = 1:maxNumPerts
        ...
        while matCount <= numMats
            ...
            try
                ...
                %data = zeros(nvars, 500*(numPerts+1)/deltat, numTrials);
                %pertTimes = zeros(1, numPerts);
                %pertLength = 0;
            catch
                continue
            end
        ...
        save(sprintf('%s/numobs%d/numperts%d/trueKs.mat', expPath, numObs, numPerts), 'trueKs');
