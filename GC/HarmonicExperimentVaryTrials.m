...
dataLog = cell(numMats, numTrialsListLength);
trueMats = nan(nvars, nvars, numMats, numTrialsListLength);
Ks = nan(nvars+2, nvars+2, numMats, numTrialsListLength);
...
predMats = nan(nvars, nvars, numMats, numTrialsListLength);
est = nan(numMats, numTrialsListLength);
numRerun = zeros(1, numTrialsListLength);
tprLog = nan(numTrialsListLength, numMats);
fprLog = nan(numTrialsListLength, numMats);
accuracyLog = nan(numTrialsListLength, numMats);
diagnosticsLog = nan(numTrialsListLength, numMats, 3);
tableResultsLog = repmat(struct([]), [numTrialsListLength, numMats]);
