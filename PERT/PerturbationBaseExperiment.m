function [votingMats, est, tableResults] = PerturbationBaseExperiment(data, mats, preprocfn, reps, freq, resultPath, dataObsIdx)
    saveData = true;
    if nargin < 6
        saveData = false;
    end
    ...
    numTrials = size(data, 3); % number of simulation trials
